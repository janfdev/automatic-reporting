...
export async function GET(req: Request) {
  ...
  const where = type === "support"
    ? and(isNotNull(dailyReports.needSupport), ne(dailyReports.needSupport, ""))
    : type === "kendala"
    ? and(isNotNull(dailyReports.formKendala), ne(dailyReports.formKendala, ""))
    : or(
        and(isNotNull(dailyReports.needSupport), ne(dailyReports.needSupport, "")),
        and(isNotNull(dailyReports.formKendala), ne(dailyReports.formKendala, ""))
      );
